function WaitingTimeByClientPerMonthD3(params){
...
$('a.medium' ).click( function() {
	...
	$.ajax({
		url: "/relatorios/tempo_de_espera_por_cliente_por_mes",
		dataType: 'json',
		data: param,
		success: function(data){
			new WaitingTimeByClientPerMonthD3({element : "#graph", data : data});
		}
	});
});
